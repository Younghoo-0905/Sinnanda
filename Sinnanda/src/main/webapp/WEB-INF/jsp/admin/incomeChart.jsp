...
<body>
	<h1>정산</h1>
				<select id="yearNo" name="yearNo" class="form-control-sm" onchange="location.href=this.value" style="float: right; margin-bottom: 20px;">
...
<canvas id="myChart" width="100" height="100"></canvas>
	...
	$.ajax({
		type:'get',
		url:'/admin/incomeChart?year=2020',
