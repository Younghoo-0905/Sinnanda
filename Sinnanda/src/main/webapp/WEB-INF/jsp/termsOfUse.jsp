...
<body onload="toBoardScroll()">
	...
	<section id="startBoard" class="ftco-section testimony-section bg-light">
		<div class="container">
			...
			<h1><strong>신난다 이용약관</strong></h1>
			
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제1조(목적)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
					...
					<br>
					&nbsp;<span style="color: red;">※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」</span>
				</div>
			</div>
			
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제2조(정의)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제3조 (약관 등의 명시와 설명 및 개정) </strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제4조(서비스의 제공 및 변경) </strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제5조(서비스의 중단)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제6조(회원가입) </strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제7조(회원 탈퇴 및 자격 상실 등) </strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제8조(회원에 대한 통지)
				</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제9조(구매신청 및 개인정보 제공 동의 등) </strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제10조 (계약의 성립)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제11조(지급방법)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제12조(수신확인통지․구매신청 변경 및 취소)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제13조(재화 등의 공급)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제14조(환급)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제15조(청약철회 등)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제16조(청약철회 등의 효과)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제17조(개인정보보호)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제18조(“몰“의 의무)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제19조(회원의 ID 및 비밀번호에 대한 의무)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제20조(이용자의 의무)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제21조(연결“몰”과 피연결“몰” 간의 관계)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">	
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제22조(저작권의 귀속 및 이용제한)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제23조(분쟁해결)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="padding: 10px;">
				<h3><strong style="color: #3c3c3c;">제24조(재판권 및 준거법)</strong></h3>
				<div style="padding-left: 20px; padding-right: 20px;">
			...
			<div style="text-align: right;">출처 : <a href="https://ftc.go.kr/www/index.do">공정거래 위원회</a></div>
		</div>
	</section>
